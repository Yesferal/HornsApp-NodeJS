...
import { concertRouter, adminConcertRouter, bandRouter, adminBandRouter, venueRouter, adminVenueRouter, stateRouter, reviewRouter, adminReviewRouter } from './routers'
